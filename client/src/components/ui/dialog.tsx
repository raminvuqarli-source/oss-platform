...
const DialogContent = React.forwardRef<
  ...
  React.ComponentPropsWithoutRef<typeof DialogPrimitive.Content> & { screenReaderTitle?: string }
>(({ className, children, screenReaderTitle, ...props }, ref) => (
  <DialogPortal>
    <DialogOverlay />
